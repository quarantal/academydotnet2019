...
namespace Fincongroup.Academy.DesignPatterns.Composite.Conceptual
{
    ...
    abstract class Component
    {
        ...
        // In some cases, it would be beneficial to define the child-
    ...
    // The Leaf class represents the end objects of a composition. A leaf
    ...
    class Client
    {
        ...
        // Thanks to the fact that the child-management operations are
