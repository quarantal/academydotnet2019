...
namespace Fincongroup.Academy.DesignPatterns.Proxy.Conceptual
{
    ...
    class Proxy : ISubject
    {
        ...
        // The most common applications of the Proxy pattern are lazy
    ...
    public class Client
    {
        // The client code is supposed to work with all objects (both
